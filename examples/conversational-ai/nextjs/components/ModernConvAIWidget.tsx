...
export function ModernConvAIWidget() {
  ...
  // Add cleanup for audio resources when component unmounts
  useEffect(() => {
    return () => {
  ...
  async function startConversation() {
    try {
      ...
      try {
        ...
        // Try direct agent ID approach as a fallback (for public agents)
        try {
          ...
          console.error("Failed to connect with agent ID:", agentIdError);
